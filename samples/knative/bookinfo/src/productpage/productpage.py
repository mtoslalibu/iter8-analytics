...
detailsServerPort = "9080" if (os.environ.get("DETAILS_SERVER_PORT") == None) else os.environ.get("DETAILS_SERVER_PORT")
ratingsServerPort = "9080" if (os.environ.get("RATINGS_SERVER_PORT") == None) else os.environ.get("RATINGS_SERVER_PORT")
reviewsServerPort = "9080" if (os.environ.get("REVIEWS_SERVER_PORT") == None) else os.environ.get("REVIEWS_SERVER_PORT")

details = {
    "name" : "http://{0}{1}:{2}".format(detailsHostname, servicesDomain, detailsServerPort),
    "endpoint" : "details",
    "children" : []
}

ratings = {
    "name" : "http://{0}{1}:{2}".format(ratingsHostname, servicesDomain, ratingsServerPort),
    "endpoint" : "ratings",
    "children" : []
}

reviews = {
    "name" : "http://{0}{1}:{2}".format(reviewsHostname, servicesDomain, reviewsServerPort),
    "endpoint" : "reviews",
    "children" : [ratings]
}
