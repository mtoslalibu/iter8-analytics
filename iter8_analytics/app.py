...
from iter8_analytics.api.analytics.endpoints.analytics import analytics_namespace
...
def config_env():
    ...
    logging.getLogger(__name__).info(u'The iter8 analytics server will listen on port {0}. '
                                     'This value can be set by the environment variable {1}'.
                                     format(app.config[constants.ITER8_ANALYTICS_SERVER_PORT_ENV],
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', debug=app.config[constants.ITER8_ANALYTICS_DEBUG_ENV],
